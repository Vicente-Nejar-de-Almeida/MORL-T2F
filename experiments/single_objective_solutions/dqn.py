...
if __name__ == '__main__':
    ...
    for nameDataset in listNameDataset:
        ...
        def make_env():
            return TestFeatureSelectionEnv(
        ...
        agent.learn(total_timesteps=1270, log_interval=1)
        ...
        if len(features_selected) > 0:
            ...
            print(f"{nameDataset}, has obtained a value of AMI equal to {AMI} with {len(features_selected)} features")
        else:
            print(f"{nameDataset}, no features selected")
